...
public class DataSourceConfig {
    ...
    public DataSource dataSource(){
        ...
        configDataSource.setUrl("jdbc:mysql://localhost:3306/hmilyylimh?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true");
        configDataSource.setDriverClassName("com.mysql.jdbc.Driver");
        configDataSource.setUsername("root");
        configDataSource.setPassword("123");
